...
%else
Source:		https://download.qt.io/%{?beta:development}%{!?beta:official}_releases/qt/%(echo %{version}|cut -d. -f1-2)/%{version}%{?beta:-%{beta}}/submodules/qtcharts-everywhere-src-%{version}%{?beta:-%{beta}}.tar.xz
%endif
